 ...
 */
//JarFile 主要增强支持对内嵌的 jar 包的获取
public class JarFile extends java.util.jar.JarFile {

	private static final String MANIFEST_NAME = "META-INF/MANIFEST.MF";

	//设置 URLStreamHandler 实现类的包路径
	// -D java.protocol.handler.pkgs = com.acme.protocol|com.acme.protocol2
	...
	public static void registerUrlProtocolHandler() {
		...
		// 将 org.springframework.boot.loader 包设置到 "java.protocol.handler.pkgs" 环境变量，从而使用到自定义的 URLStreamHandler 实现类 Handler，处理 jar: 协议的 URL。
		System.setProperty(PROTOCOL_HANDLER, ("".equals(handlers) ? HANDLERS_PACKAGE
				: handlers + "|" + HANDLERS_PACKAGE));
		// 重置已缓存的 URLStreamHandler 处理器们
		// URLStreamHandler的内容见 https://blog.csdn.net/xiaomin1991222/article/details/50980754
